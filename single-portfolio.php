    ...
    <?php if ( have_posts() ) : the_post(); ?>
        ...
        ?>
            <div style="margin-top:3rem; padding-top:2rem; border-top:1px solid #e5e5e5; display:flex; gap:4rem; flex-wrap:wrap;">
                <?php if ( $concept ) : ?>
                    <div>
                        <span style="font-size:10px; letter-spacing:0.15em; text-transform:uppercase; color:#585058; display:block; margin-bottom:0.4rem;">CONCEPT</span>
                        <p style="font-size:13px; color:#231f20;"><?php echo esc_html( $concept ); ?></p>
                    </div>
                <?php endif; ?>
                <?php if ( $palette ) : ?>
                    <div>
                        <span style="font-size:10px; letter-spacing:0.15em; text-transform:uppercase; color:#585058; display:block; margin-bottom:0.4rem;">PALETTE</span>
                        <p style="font-size:13px; color:#231f20;"><?php echo esc_html( $palette ); ?></p>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
