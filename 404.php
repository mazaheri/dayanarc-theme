...
<main style="max-width:860px; margin:0 auto; padding:8rem 2rem 6rem; min-height:60vh; display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center;">
    ...
    <span style="font-size:10px; letter-spacing:0.2em; text-transform:uppercase; color:#585058; font-weight:500; display:block; margin-bottom:2rem;">ERROR 404</span>

    <h1 class="title-text" style="font-size:clamp(4rem,14vw,9rem); line-height:0.95; letter-spacing:0.02em; color:#231f20; margin-bottom:2.5rem;">
        NOT<br>FOUND
    </h1>
    ...
    <a href="<?php echo esc_url( home_url( '/' ) ); ?>"
       style="font-size:11px; letter-spacing:0.15em; text-transform:uppercase; font-weight:600; color:#231f20; text-decoration:none; display:inline-flex; align-items:center; gap:0.75rem; border-bottom:1px solid #231f20; padding-bottom:0.2rem;">
        BACK TO HOME
