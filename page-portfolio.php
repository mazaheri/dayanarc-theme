 ...
 *
 * Used as the Portfolio archive page (created by the demo importer).
 * Queries the 'portfolio' CPT directly so it works as a regular page
 * without conflicting with the CPT archive rewrite rules.
 */
get_header( 'inner' );
                ...
                <div>
                    <div class="curtain-container" style="aspect-ratio:1/1; width:100%;">
                        <img src="<?php echo esc_url( $img_large ); ?>"
                             ...
                             class="curtain-img-portfolio archive-curtain active"
